...
Dr.Jihjane Li, an independant doctor in the state of Washington, provided us with a dataset which categorized the Diagnostic Related Groups by the body system they impact and the medical department which would be responsible for it.
...
# Data Exploration Critique
To create the parent dataset which we would using for our investigation, we first began by conducting a data exploration critique of the DRG datasets we collected.
